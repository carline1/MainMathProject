namespace MainMathProject
{
    partial class FileHelperForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label3.Text = " первая строка - массив x, вторая строка - массив y";
            // 
            // label4
            // 
            ...
            this.label4.Text = "Данные должны разделяться точкой с запятой ( ; ),";
            // 
            // label5
            // 
            ...
            this.label5.Text = " после конечного элемента ставить ; не нужно";
            // 
            // open_file
            // 
